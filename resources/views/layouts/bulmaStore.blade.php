<html lang="en"><head>
    <title> Spacelab • Bulmaswatch - Free themes for Bulma - A modern CSS framework based on Flexbox </title>
    <meta charset="utf-8">
  ...
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/bulmaswatch/assets/icons/apple-touch-icon-144x144.png">
  <link rel="apple-touch-icon-precomposed" sizes="152x152" href="/bulmaswatch/assets/icons/apple-touch-icon-152x152.png">
  <link rel="icon" type="image/png" href="/bulmaswatch/assets/icons/favicon-32x32.png" sizes="32x32">
  <link rel="icon" type="image/png" href="/bulmaswatch/assets/icons/favicon-16x16.png" sizes="16x16">
  ...
  <meta name="msapplication-TileImage" content="/bulmaswatch/assets/icons/mstile-144x144.png">
  <meta property="og:title" content="Bulmaswatch">
  <meta property="og:description" content="Free themes for Bulma - A modern CSS framework based on Flexbox">
  <meta property="og:image" content="https://jenil.github.io/bulmaswatch/assets/bulmaswatch-banner.png">
  <meta property="og:url" content="https://jenil.github.io/bulmaswatch">
  <meta name="twitter:site" content="@jgog">
  <meta name="twitter:card" content="summary_large_image">

  <meta name="google-site-verification" content="cVTIST6ExYmdvYtY2HKbKNQhvHbsDuS2oaPN9im5hnk">

    <link href="/bulmaswatch/spacelab/bulmaswatch.min.css" rel="stylesheet">
    <style>
      .hero .container {
        width: 95%;
      }
  ...
  <body class="theme-page">
    ...
    <div class="container">
          ...
          <div class="navbar-dropdown is-boxed">
            <div class="columns">
              <div class="column">
                  ...
                  <a class="navbar-item " href="https://jenil.github.io/bulmaswatch/cerulean"> Cerulean </a>
              ...
              <div class="column">
                  ...
                  <a class="navbar-item is-active" href="https://jenil.github.io/bulmaswatch/spacelab"> Spacelab </a>
      ...
      <div class="navbar-end navbar-menu">
        ...
        <a class="navbar-item" href="//github.com/jenil/bulmaswatch/issues" target="_blank" onclick="ga('send', 'event', 'nav', 'click', 'issue');">
          <i class="fa fa-bug"></i>&nbsp;Report an issue
        </a>
        <a class="navbar-item" href="//github.com/jenil/bulmaswatch" target="_blank" onclick="ga('send', 'event', 'nav', 'click', 'github');">
          <span class="icon"> <i class="fa fa-github"></i> </span>
        </a>
        <a class="navbar-item" href="//twitter.com/geekGogari" target="_blank" onclick="ga('send', 'event', 'nav', 'click', 'twitter');">
      ...
      <div class="hero-body">
        <div class="container">
          ...
          <p>
            <a class="button is-primary is-inverted" href="/bulmaswatch/spacelab/bulmaswatch.min.css" target="_blank" onclick="ga('send', 'event', 'theme', 'download', 'Spacelab');">Download</a>
            <a class="button is-dark" href="//github.com/jenil/bulmaswatch/tree/gh-pages/spacelab" target="_blank" onclick="ga('send', 'event', 'theme', 'github', 'Spacelab');" title="Download from Github">
              <span class="icon"> <i class="fa fa-github"> </i> </span>
            </a>
          </p>
        </div>
    ...
    <div class="container">
      <div class="content has-text-centered">
        <p>
          ...
          &nbsp;
          <a class="icon" href="//twitter.com/geekGogari" target="_blank" onclick="ga('send', 'event', 'footer', 'click', 'twitter');">
            <i class="fa fa-twitter"></i>
          </a>
        </p>
        <p>
